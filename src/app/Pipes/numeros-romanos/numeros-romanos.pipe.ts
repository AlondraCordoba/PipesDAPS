...
export class NumerosRomanosPipe implements PipeTransform {
  ...
  transform(value: number): string {
    ...
    {
      case 1: this.romano = this.romano + 'C'; break;
      case 2: this.romano = this.romano + 'CC'; break;
      case 3: this.romano = this.romano + 'CCC'; break;
      case 4: this.romano = this.romano + 'CD'; break;
      case 5: this.romano = this.romano + 'D'; break;
      case 6: this.romano = this.romano + 'DC'; break;
      case 7: this.romano = this.romano + 'DCC'; break;
      case 8: this.romano = this.romano + 'DCCC'; break;
